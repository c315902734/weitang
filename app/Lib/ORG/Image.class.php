...
//        $maxSize   = $maxSize * 1024;
    ...
    {
        import('ORG.Util.ClsString');
        $randval = ClsString::randString($length, $mode);
        // 生成验证码时，直接md5加密付给verify 变量
    ...
    {
        import('ORG.Util.ClsString');
        $code  = ClsString::randString($length, 4);
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            $codex     = ClsString::msubstr($code, $i, 1);
    ...
    static function cropByData($src, $dst, $data)
    {
